...
<html class="no-js" lang="en">
    <body>
        ...
        $response = Unirest\Request::post('http://anderskitchen.com:9000/session', $headers, $body);
        ...
        $response = Unirest\Request::get('http://anderskitchen.com:9000/user', $headers);

        $result = count($response->body);
        echo $result;
        echo $response->raw_body;

        $response = Unirest\Request::get('http://anderskitchen.com:9000/user/2', $headers);
