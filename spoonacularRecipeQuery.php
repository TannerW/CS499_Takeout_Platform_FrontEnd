...
function spoonacularRecipeQuery($type, $query, $cuisine, $diet) {
    ...
    $response = Unirest\Request::get("https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/search?diet=$diet&type=$type&query=$query&cuisine=$cuisine", array(
