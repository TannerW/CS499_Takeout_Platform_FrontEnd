            ...
            <div class="hero row collapse">
                <div class="menu-bar medium-2 columns">
                    ...
                    <ul class="tabs vertical" id="example-vert-tabs" data-tabs>
                        ...
                        <li class="tabs-title"><a href="#panel6v">All Orders</a></li>
                    </ul>
                </div>
                <div class="medium-10 columns">
                    <div class="tabs-content vertical" data-tabs-content="example-vert-tabs">
                        ...
                        <div class="tabs-panel RecipeBook" id="panel3v">
                            <div class="row full">
                                <div class="large-12" style="min-height: 100vh;">
                                    <iframe style="width: 100%; min-height:inherit;" width=100% height=100% marginwidth=0 marginheight=0 frameBorder="0" src="RecipeBook.php"></iframe>
                                </div>
                            </div>
                        </div>
...
<!--                            <div class="top-bar RecipeTopBar">
                        ...
                        <div class="tabs-panel AllOrders" id="panel6v">
                            <?php
                                require_once 'PHPHelpers/getAllOrders.php';
                                $menu = getAllOrders();
                                echo($menu);
                            ?>
                        </div>
...
<?php } ?>
   ...
   $(document).ready(function () {
        $('#deleteMenuSubmit').on('submit', function(e){
            e.preventDefault();
            var mealDate = $('input#mealDate').val();
            console.log(mealDate);
            var formData = 'mealDate' + mealDate;
        $.ajax({
            type: 'POST',
            url: '/PHPHelpers/deleteFromMenu.php',
            data: formData
